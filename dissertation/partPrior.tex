...
Figure \ref{fig:tdf21PSampDist} shows the sample distributions, where we can see that the partitioned prior results in a smoother distribution that does a better job of representing the true posterior.
