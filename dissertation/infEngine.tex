...
\label{pplBack}
There are many PPLs in existance and therefore many different techniques for building PPLs. Here we use the ``Lightweight implementation'' method proposed by Wingate \cite{wingate2011lightweight}, which can be used to modify any existing programming language into a PPL with relative ease.
